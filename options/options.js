...
const OPT_I18N = {
  en: {
    ...
    optAutoCheckAIDesc: 'When applying all, also tick the two AI declaration checkboxes on the Adobe Stock form.',
    optAutoSaveAfterApply: 'Auto-save after Apply All',
    optAutoSaveAfterApplyDesc: 'After applying all metadata, automatically click the "Save work" button on Adobe Stock.',
  ...
  zh: {
    ...
    optAutoCheckAIDesc: '点击「全部应用」时，同时勾选 Adobe Stock 表单上的「使用生成式 AI 工具创建」与「人物与财产均为虚构」两项。',
    optAutoSaveAfterApply: '全部应用后自动保存',
    optAutoSaveAfterApplyDesc: '点击「全部应用」后，自动点击 Adobe Stock 页面上的「保存」按钮。',
    optTest: '测试连接',
    optSave: '保存',
    optSaved: '设置已保存。',
