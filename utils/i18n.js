...
(function () {
  const I18N = {
    en: {
      ...
      applyFileType: 'Apply File Type',
      appliedCategory: 'Category applied.',
      appliedFileType: 'File type applied.',
      appliedAll: 'Title, keywords, category and file type applied.',
      noCategory: 'No category suggested yet.',
      noFileType: 'No file type suggested yet.',
    ...
    zh: {
      ...
      appliedFileType: '文件类型已应用。',
      appliedAll: '标题、关键词、类别与类型已应用。',
      noCategory: '尚未推荐类别。',
      noFileType: '尚未推荐文件类型。',
